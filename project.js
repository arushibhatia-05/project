...
d3.csv("sankey_data.csv").then(function(data) {
  ...
  // Define color scales for nodes and links
  ...
  // Render links with tooltip events and individual color hover
  svg.append("g")
    .attr("fill", "none")
    .selectAll("path")
    .data(graph.links)
  ...
  // Render nodes with tooltip events and individual color hover
